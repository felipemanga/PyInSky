...
QDEF(MP_QSTR_ANALOG_IN, (const byte*)"\xf7\x09" "ANALOG_IN")
QDEF(MP_QSTR_BUT_A, (const byte*)"\x78\x05" "BUT_A")
QDEF(MP_QSTR_BUT_B, (const byte*)"\x7b\x05" "BUT_B")
QDEF(MP_QSTR_BUT_C, (const byte*)"\x7a\x05" "BUT_C")
QDEF(MP_QSTR_CHECKED_TILE, (const byte*)"\xa9\x0c" "CHECKED_TILE")
QDEF(MP_QSTR_Cookie, (const byte*)"\x41\x06" "Cookie")
QDEF(MP_QSTR_DOWN_ARROW_TILE, (const byte*)"\x1a\x0f" "DOWN_ARROW_TILE")
QDEF(MP_QSTR_EMPTY_TILE, (const byte*)"\xdb\x0a" "EMPTY_TILE")
QDEF(MP_QSTR_EXT0, (const byte*)"\x5c\x04" "EXT0")
QDEF(MP_QSTR_EXT1, (const byte*)"\x5d\x04" "EXT1")
QDEF(MP_QSTR_EXT10, (const byte*)"\xcd\x05" "EXT10")
QDEF(MP_QSTR_EXT11, (const byte*)"\xcc\x05" "EXT11")
QDEF(MP_QSTR_EXT12, (const byte*)"\xcf\x05" "EXT12")
QDEF(MP_QSTR_EXT13, (const byte*)"\xce\x05" "EXT13")
QDEF(MP_QSTR_EXT14, (const byte*)"\xc9\x05" "EXT14")
QDEF(MP_QSTR_EXT15, (const byte*)"\xc8\x05" "EXT15")
QDEF(MP_QSTR_EXT16, (const byte*)"\xcb\x05" "EXT16")
QDEF(MP_QSTR_EXT17, (const byte*)"\xca\x05" "EXT17")
QDEF(MP_QSTR_EXT2, (const byte*)"\x5e\x04" "EXT2")
QDEF(MP_QSTR_EXT3, (const byte*)"\x5f\x04" "EXT3")
QDEF(MP_QSTR_EXT4, (const byte*)"\x58\x04" "EXT4")
QDEF(MP_QSTR_EXT5, (const byte*)"\x59\x04" "EXT5")
QDEF(MP_QSTR_EXT6, (const byte*)"\x5a\x04" "EXT6")
QDEF(MP_QSTR_EXT7, (const byte*)"\x5b\x04" "EXT7")
QDEF(MP_QSTR_EXT8, (const byte*)"\x54\x04" "EXT8")
QDEF(MP_QSTR_EXT9, (const byte*)"\x55\x04" "EXT9")
QDEF(MP_QSTR_EventType, (const byte*)"\x91\x09" "EventType")
QDEF(MP_QSTR_IN, (const byte*)"\x22\x02" "IN")
QDEF(MP_QSTR_KEYDOWN, (const byte*)"\xe0\x07" "KEYDOWN")
QDEF(MP_QSTR_KEYUP, (const byte*)"\xb7\x05" "KEYUP")
QDEF(MP_QSTR_KEY_c, (const byte*)"\xce\x05" "KEY_c")
QDEF(MP_QSTR_KEY_x, (const byte*)"\xd5\x05" "KEY_x")
QDEF(MP_QSTR_KEY_z, (const byte*)"\xd7\x05" "KEY_z")
QDEF(MP_QSTR_K_DOWN, (const byte*)"\x03\x06" "K_DOWN")
QDEF(MP_QSTR_K_LEFT, (const byte*)"\xea\x06" "K_LEFT")
QDEF(MP_QSTR_K_RIGHT, (const byte*)"\xb1\x07" "K_RIGHT")
QDEF(MP_QSTR_K_UP, (const byte*)"\x94\x04" "K_UP")
QDEF(MP_QSTR_LEFT_ARROW_TILE, (const byte*)"\x13\x0f" "LEFT_ARROW_TILE")
QDEF(MP_QSTR_NOEVENT, (const byte*)"\x88\x07" "NOEVENT")
...
QDEF(MP_QSTR_RIGHT_ARROW_TILE, (const byte*)"\xe8\x10" "RIGHT_ARROW_TILE")
QDEF(MP_QSTR_Rect, (const byte*)"\xc5\x04" "Rect")
QDEF(MP_QSTR_SPACE_TILE, (const byte*)"\x6a\x0a" "SPACE_TILE")
QDEF(MP_QSTR_Signal, (const byte*)"\x9b\x06" "Signal")
QDEF(MP_QSTR_Sound, (const byte*)"\xc6\x05" "Sound")
QDEF(MP_QSTR_Surface, (const byte*)"\xb0\x07" "Surface")
QDEF(MP_QSTR_TAS, (const byte*)"\x03\x03" "TAS")
QDEF(MP_QSTR_Tilemap, (const byte*)"\x4d\x07" "Tilemap")
QDEF(MP_QSTR_UNCHECKED_TILE, (const byte*)"\x92\x0e" "UNCHECKED_TILE")
QDEF(MP_QSTR_UP_ARROW_TILE, (const byte*)"\x6d\x0d" "UP_ARROW_TILE")
QDEF(MP_QSTR_bin, (const byte*)"\xe0\x03" "bin")
QDEF(MP_QSTR_blit, (const byte*)"\xf6\x04" "blit")
QDEF(MP_QSTR_blit_framebuf, (const byte*)"\x45\x0d" "blit_framebuf")
QDEF(MP_QSTR_bound_method, (const byte*)"\x97\x0c" "bound_method")
QDEF(MP_QSTR_centerx, (const byte*)"\x76\x07" "centerx")
QDEF(MP_QSTR_centery, (const byte*)"\x77\x07" "centery")
...
QDEF(MP_QSTR_colliderect, (const byte*)"\x41\x0b" "colliderect")
...
QDEF(MP_QSTR_draw, (const byte*)"\xa5\x04" "draw")
QDEF(MP_QSTR_drawBox, (const byte*)"\xf0\x07" "drawBox")
QDEF(MP_QSTR_drawGauge, (const byte*)"\x94\x09" "drawGauge")
QDEF(MP_QSTR_draw_text, (const byte*)"\x87\x09" "draw_text")
QDEF(MP_QSTR_enable, (const byte*)"\x04\x06" "enable")
QDEF(MP_QSTR_event, (const byte*)"\xc9\x05" "event")
QDEF(MP_QSTR_fill, (const byte*)"\xca\x04" "fill")
QDEF(MP_QSTR_fillRectTiles, (const byte*)"\x8d\x0d" "fillRectTiles")
QDEF(MP_QSTR_fill_buffer, (const byte*)"\x35\x0b" "fill_buffer")
...
QDEF(MP_QSTR_get_current_soundbuffer_index, (const byte*)"\x38\x1d" "get_current_soundbuffer_index")
QDEF(MP_QSTR_get_current_soundbuffer_pos, (const byte*)"\x6a\x1b" "get_current_soundbuffer_pos")
QDEF(MP_QSTR_get_rect, (const byte*)"\xec\x08" "get_rect")
QDEF(MP_QSTR_get_soundbuffer_size, (const byte*)"\x35\x14" "get_soundbuffer_size")
QDEF(MP_QSTR_get_tile_id, (const byte*)"\xaa\x0b" "get_tile_id")
QDEF(MP_QSTR_get_tile_ids, (const byte*)"\x99\x0c" "get_tile_ids")
...
QDEF(MP_QSTR_mixer, (const byte*)"\x4e\x05" "mixer")
...
QDEF(MP_QSTR_play_from_sd, (const byte*)"\x80\x0c" "play_from_sd")
QDEF(MP_QSTR_play_sfx, (const byte*)"\xf3\x08" "play_sfx")
QDEF(MP_QSTR_poll, (const byte*)"\x9a\x04" "poll")
QDEF(MP_QSTR_printInteger, (const byte*)"\x12\x0c" "printInteger")
QDEF(MP_QSTR_printString, (const byte*)"\x81\x0b" "printString")
...
QDEF(MP_QSTR_setCursor, (const byte*)"\x8d\x09" "setCursor")
QDEF(MP_QSTR_setTile, (const byte*)"\x53\x07" "setTile")
QDEF(MP_QSTR_set_background_color, (const byte*)"\xb4\x14" "set_background_color")
QDEF(MP_QSTR_set_clip, (const byte*)"\x0e\x08" "set_clip")
QDEF(MP_QSTR_set_foreground_color, (const byte*)"\xc1\x14" "set_foreground_color")
QDEF(MP_QSTR_set_mode, (const byte*)"\x3b\x08" "set_mode")
QDEF(MP_QSTR_set_palette, (const byte*)"\x25\x0b" "set_palette")
QDEF(MP_QSTR_set_palette_16bit, (const byte*)"\x82\x11" "set_palette_16bit")
QDEF(MP_QSTR_set_tile, (const byte*)"\x4c\x08" "set_tile")
QDEF(MP_QSTR_set_transparent_color, (const byte*)"\xbc\x15" "set_transparent_color")
...
QDEF(MP_QSTR_tilemap, (const byte*)"\x2d\x07" "tilemap")
QDEF(MP_QSTR_time_ms, (const byte*)"\x51\x07" "time_ms")
QDEF(MP_QSTR_umachine, (const byte*)"\x95\x08" "umachine")
QDEF(MP_QSTR_upygame, (const byte*)"\xd7\x07" "upygame")
